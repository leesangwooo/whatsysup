...
.antd-pro-page-header-pageHeader {
  ...
  .antd-pro-page-header-detail {
    display: flex;
  }

  .antd-pro-page-header-row {
    display: flex;
    width: 100%;
  }
  ...
  .antd-pro-page-header-action,
  .antd-pro-page-header-extraContent,
  .antd-pro-page-header-main {
    flex: 0 1 auto;
  }
