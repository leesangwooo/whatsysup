...
var EllipsisText = function EllipsisText(_ref) {
  var text = _ref.text,
      ...
      other = _objectWithoutProperties(_ref, ['text', 'length', 'tooltip', 'fullWidthRecognition']);
  ...
  if (tooltip) {
    return _react2.default.createElement(
      _tooltip2.default,
      { overlayStyle: { wordBreak: 'break-all' }, title: text },
      ...
      if (isSupportLineClamp) {
        ...
        return _react2.default.createElement(
          ...
          tooltip ? _react2.default.createElement(
            _tooltip2.default,
            { overlayStyle: { wordBreak: 'break-all' }, title: children },
            children
          ) : children
        );
      }
