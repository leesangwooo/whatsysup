    ...
    render() {
        ...
        return (
            <div className="poll-content">
                ...
                <div>
                    <CustomChart poll={this.props.poll}/>
                </div>
                <div>
                    <CustomTag
                        tagMaps={JSON.parse(this.props.poll.tags) || {}}
                ...
                <div className="poll-footer">
                    {!(this.props.poll.selectedChoice || this.props.poll.expired) ? (
                        ...
                        >
                            <Icon type="like-o" /> Like
                        </Button>
                    ) : null}
                    <span className="total-votes">{this.props.poll.totalVotes} likes</span>
...
function CompletedOrVotedPollChoice(props) {
    return (
        <div className="cv-poll-choice">
            ...
            <span
                className={
                    props.isWinner ? 'cv-choice-percent-chart winner' : 'cv-choice-percent-chart'
                }
